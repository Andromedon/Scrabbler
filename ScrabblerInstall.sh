...
usage() {
  cat <<'EOF'
Usage:
  ./ScrabblerInstall.sh [--debug|--release] [--device DEVICE_ID]
...
echo "Building Scrabbler.Maui (${CONFIGURATION}) for ${RUNTIME}..."
...
echo "Installed ${CONFIGURATION} build on ${DEVICE_ID}."
